...
if (isset($_GET['logout'])) {
	unset($_SESSION['user'], $_SESSION['isAdmin'], $_SESSION['rights']);
	session_unset();
	session_destroy();
	$host = 
	//header('Location: http://localhost/cf-files/FSWD40-Project04/Project/Controller/Session_controller/index_controller.php');
